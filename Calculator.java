...
public class Calculator {
    ...
    public static void main(String[] args) {
        try {
            ...
            Connection con = DriverManager.getConnection("jbdc:mysql://localhost/calculatordb", "root", "Biggerbraintime510.");
            Statement stmt = con.createStatement();
            ResultSet rs = stmt.executeQuery("select * from tblcalc");
            while(rs.next()){
                System.out.println(rs.getString("tblcalc") + " " + rs.getString("tblcalc"));
            }
